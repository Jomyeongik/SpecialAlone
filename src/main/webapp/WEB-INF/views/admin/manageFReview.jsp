            ...
            <div id="main_middle">
                ...
                <div class="search">
                	<select id="boardType">
                		...
                		<option value="fReview" selected>음식 포토 리뷰</option>
                	</select>
                	<br>
	            ...
	            <table class="table table-striped table-hover">
	                    ...
	                    <tbody class="table-group-divider">
							<c:forEach var="fReview" items="${fList}">
								<tr>
									<td style="text-align:center">${fReview.fReviewId }</td>
									<td><a href="/noticeEvent/detail.do?boardNo=${fReview.fProductId }">${fReview.fProductId }</a></td>
									<td><a href="/noticeEvent/detail.do?boardNo=${fReview.fReviewId }">${fReview.fReviewTitle }</a></td>
									<td style="text-align:center">${fReview.fUserNo }</td>
									<td style="text-align:center">
										<button class="userDetail" onclick="javascript: location.href='/noticeEvent/modify.do?boardNo=${fReview.fReviewId }'">수정</button>
										<button class="userDelete" onclick="if (confirm('삭제 하시겠습니까?')) { location.href = '/noticeEvent/delete.do?boardNo=${fReview.fReviewId }'; window.location.href = window.location.href; }">삭제</button>
									</td>
								</tr>
							</c:forEach>
						</tbody>
						<tfoot>
							<tr align="center">
								...
								<c:if test="${pInfo.currentPage != 1 }">
									<a href="/manageBoard.do?selectedValue=fReview&currentPage=${pInfo.currentPage - 1 }">&lt;</a>&nbsp;
								</c:if>
								<c:forEach begin="${pInfo.startNavi }" end="${pInfo.endNavi }" var="p">
									<c:url var="pageUrl" value="/manageBoard.do">
										<c:param name="selectedValue" value="fReview"></c:param>
