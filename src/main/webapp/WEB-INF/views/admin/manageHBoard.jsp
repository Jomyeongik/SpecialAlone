            ...
            <div id="main_middle">
                ...
                <div class="search">
                    ...
                    <form action="/singo/search.do" method="get">
						<input type="text" name="searchKeyword" placeholder="게시글타입선택 ex)후기,질문,소모임모집" style="width:30%">
							...
							<c:forEach var="notice" items="${hList}">
								<tr>
									...
									<td style="text-align:center">
										<button onclick="if (confirm('삭제 하시겠습니까?')) { location.href = '/noticeEvent/delete.do?boardNo=${notice.hBoardNo }'; window.location.href = window.location.href; }">삭제</button>
									</td>
								</tr>
							</c:forEach>
						</tbody>
